...
function generateTrascriptQuestion() {
    ...
    document.getElementById('demo-rna-answer').style.display = 'inline-block';
    }
...
function checkRNA() {
    if (rnaAnswer == userInput) {
        ...
        document.getElementById("demo-rna-answer").style.display = "none";
        document.getElementById('container-submit-peptide').style.visibility = "visible";
        document.getElementById('aa-table').style.visibility = "visible";
        document.getElementById("demo-peptide-answer").style.display = "inline-block";
    } else {
...
function checkPeptide() {
    if (peptideAnswer.toUpperCase() == userInput) {
        ...
        document.getElementById("demo-peptide-answer").style.display = "none";
    } else {
...
function getRandomInt(min, max) {
  ...
  function resetPage() {
    ...
    document.getElementById('aa-table').style.visibility = "hidden";
    document.getElementById('reveal-rna').textContent = " ";
    document.getElementById('reveal-peptide').textContent = " ";
  }
  ...
  function revealAnswer(id) {
      if (id == "rna")
        document.getElementById("reveal-rna").textContent = rnaAnswer;
    else if (id == "peptide")
    document.getElementById("reveal-peptide").textContent = peptideAnswer;
